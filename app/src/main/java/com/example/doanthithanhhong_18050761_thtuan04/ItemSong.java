...
public class ItemSong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prev = findViewById(R.id.imgUndo);
        next = findViewById(R.id.imgNext);
        imageView = findViewById(R.id.imgMusic);
        songTitle = findViewById(R.id.txtMusic);
        songSinger = findViewById(R.id.txtNameAuthor);
